package tn.usine.articlemanager.web.rest;
...
import tn.usine.articlemanager.service.ArticleService;
import tn.usine.articlemanager.service.dto.ArticleDTO;
import tn.usine.articlemanager.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tn.usine.articlemanager.domain.Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
    ...
    private static final String ENTITY_NAME = "articledbArticle";
    ...
    public ResponseEntity<ArticleDTO> updateArticle(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, articleDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ArticleDTO> partialUpdateArticle(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, articleDTO.getId())
        );
    }
