...
import tn.usine.gateway.GatewayusineApp;
import tn.usine.gateway.config.AsyncSyncConfiguration;
import tn.usine.gateway.config.EmbeddedMongo;
...
@SpringBootTest(classes = { GatewayusineApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
