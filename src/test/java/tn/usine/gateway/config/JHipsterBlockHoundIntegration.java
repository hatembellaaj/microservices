package tn.usine.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tn.usine.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tn.usine.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
