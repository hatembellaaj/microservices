...
import tn.usine.articlemanager.IntegrationTest;
...
class ArticleResourceIT {
    ...
    public static Article createEntity() {
        Article article = new Article().name(DEFAULT_NAME).price(DEFAULT_PRICE).idcategory(DEFAULT_IDCATEGORY);
        return article;
    }
    ...
    public static Article createUpdatedEntity() {
        Article article = new Article().name(UPDATED_NAME).price(UPDATED_PRICE).idcategory(UPDATED_IDCATEGORY);
        return article;
    }
    ...
    void putExistingArticle() throws Exception {
        ...
        updatedArticle.name(UPDATED_NAME).price(UPDATED_PRICE).idcategory(UPDATED_IDCATEGORY);
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.name(UPDATED_NAME).price(UPDATED_PRICE).idcategory(UPDATED_IDCATEGORY);
